package io.github.theodorekonikowski.harbor.ui
...
import io.github.theodorekonikowski.harbor.HarborGraph
import io.github.theodorekonikowski.harbor.core.policy.WorkProfileStatus
import io.github.theodorekonikowski.harbor.feature.advanced.AdvancedScreen
...
fun HarborRoot(
    ...
    val profileState by graph.policyController.observeState().collectAsStateWithLifecycle(
        initialValue = io.github.theodorekonikowski.harbor.core.policy.WorkProfileState(
